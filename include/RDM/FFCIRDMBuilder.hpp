...
// 
#ifndef GQCP_FFCIRDMBUILDER_HPP
#define GQCP_FFCIRDMBUILDER_HPP
 ...
 */
class FFCIRDMBuilder : public BaseRDMBuilder {
...
public:
    // CONSTRUCTORS
    FFCIRDMBuilder(const ProductFockSpace& fock_space, size_t freeze);


    // DESTRUCTOR
    ~FFCIRDMBuilder() = default;
