...
// 
#ifndef GQCP_FOCKSPACEINTERFACE_HPP
#define GQCP_FOCKSPACEINTERFACE_HPP
...
private:
     ...
     */
    virtual size_t ulongNextPermutation(size_t representation) const;


public:
    // DESTRUCTORS
    virtual ~FockSpaceInterface() = 0;
...
#endif  // GQCP_FOCKSPACEINTERFACE_HPP
