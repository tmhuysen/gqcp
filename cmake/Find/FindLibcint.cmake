...
if("${LIBCINT_PREFIX}" STREQUAL "LIBCINT_PREFIX-NOTFOUND")
    ...
    if(EXISTS ${LIBCINT_PREFIX}/lib/libcint.so)
        set(Libcint_LIBRARIES "${Libcint_LIBRARIES};${LIBCINT_PREFIX}/lib/libcint.so")
    else()
        if(EXISTS ${LIBCINT_PREFIX}/lib/libcint.dylib)
            set(Libcint_LIBRARIES "${Libcint_LIBRARIES};${LIBCINT_PREFIX}/lib/libcint.dylib")
        else()
            set(Libcint_LIBRARIES "${Libcint_LIBRARIES};${LIBCINT_PREFIX}/lib/libcint.a")
        endif()
    endif()
